...
const UPGRADE_CATALOG: UpgradeDefinition[] = [
  ...
  { id: "outlook-templates", category: "speed", title: "Modelli di Outlook", description: "Blocchi di testo pronti accelerano e impaginano ogni campagna.", effectLabel: "+1 carattere per input · sblocca l'email impaginata", effect: "writingPower", effectPerLevel: 1, baseCost: 45, costGrowth: GROWTH, maxLevel: 5, requiredHistoricMembers: 5 },
  ...
  { id: "call-to-action", category: "writing", title: "Call to action", description: "Il passo successivo diventa chiaro, visibile e cliccabile.", effectLabel: "+15% prenotazioni · sblocca pulsanti e link", effect: "bookingMultiplier", effectPerLevel: 0.15, baseCost: 120, costGrowth: GROWTH, maxLevel: 5, requiredHistoricMembers: 15 },
