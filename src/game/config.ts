...
export const GAME_CONFIG = {
  ...
  socialIncomePerMemberPerFollower: 0.001,
  socialFollowerChance: 0.25,
  socialTrialChance: 0.0001,
  socialContactChance: 0.001,
  socialTrialChancePerFollower: 0.000001,
  socialContactChancePerFollower: 0.000002,
